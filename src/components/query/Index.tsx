...
function ToolStepItem({
  ...
  step: { name: string; input: string; output: string; status: "running" | "done" };
  index: number;
}) {
  return (
    ...
    <div className="space-y-6 w-full py-2 md:py-3 text-zinc-900 dark:text-zinc-100 transition-colors duration-200">
      ...
      {(response || isStreaming || displayAnswer || toolSteps.length > 0) && (
        <div className="grid lg:grid-cols-3 gap-6 items-start w-full">
          {/* LEFT/CENTER: Thinking Steps & Main Answer */}
          <div className="lg:col-span-2 space-y-5 w-full">
            ...
            <div className="p-5 rounded-xl border bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm space-y-3 w-full">
              ...
              <p className="text-base leading-relaxed whitespace-pre-line break-words text-zinc-800 dark:text-zinc-200 w-full">
                {displayAnswer ||
                  (isStreaming ? (
            ...
            {hasMetadata && (
              <div className="space-y-3 mt-10 w-full">
                <div className="flex items-center justify-between flex-wrap gap-2 w-full">
                  ...
                  <p className="text-[15px] text-zinc-400 border-emerald-400 rounded-md border p-2 break-words">
          ...
          {/* RIGHT: Lexical Panels (Expert Mode & Responses only) */}
