...
import { Plus, Loader2, Database, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Chunks() {
  ...
  return (
    <div className="min-h-full bg-zinc-50 dark:bg-black p-6">
      <div className="max-w-[95%] mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-black dark:bg-white text-white dark:text-black text-sm font-medium rounded-lg hover:opacity-90 active:scale-[0.98] transition-all"
          >
          ...
          <div className="flex items-center justify-between pt-6 border-t border-zinc-200 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={page === 1}
                className="p-2 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
